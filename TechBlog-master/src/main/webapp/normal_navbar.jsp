        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="index.jsp#langinfo">Programming Language</a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="contactus.jsp"> <span class="	fa fa-address-card-o"></span> Contact</a>
            </li>
            <li class="nav-item">
